...
//	OLED_Draw_Rounded_Cube(63, 31, 30, 60, 30, FILL);OLED_Refresh_Gram();
//	OLED_Draw_Rounded_Cube(63, 31, 60, 30, 15, FILL);OLED_Refresh_Gram();
//	OLED_Fill(0, 0, OLED_COL_MAX-1, OLED_ROW_MAX-1, FILL);
